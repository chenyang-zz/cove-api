...
This project is indexed by GitNexus as **cove** (11564 symbols, 47247 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.

...
This project is indexed by GitNexus as **boxify-api-go** (9792 symbols, 38626 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
